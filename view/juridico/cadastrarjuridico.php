		...
		<div class="container-login100" style="background-image: url('../../layout/app/images/bg-01.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="ControllerFisico.php">
					...
					<div class="wrap-input100 validate-input" data-validate = "Razão Social">
						<input class="input100" type="text" name="razaosocial" placeholder="Razão Social">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate = "Nome Fantasia">
						<input class="input100" type="text" name="nomefantasia" placeholder="Nome Fantasia">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate = "Nome do Responsável">
					...
					<div class="wrap-input100 validate-input"">
						<input class="input100" type="file" name="logo" placeholder="sua logo">
						<span class="focus-input100" data-placeholder="&#xf3e0;"></span>
					</div>
