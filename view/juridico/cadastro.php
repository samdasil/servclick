<?php
    ...
    if( isset($_POST) && !empty($_POST) || isset($_GET) && !empty($_GET)){
        ...
        if((isset($_FILES['foto']['size']) && $_FILES['foto']['size'] != 0) || (isset($_FILES['foto']['size']) && $_FILES['foto']['size'] != 0)) {
                ...
                <div class="contact-form bottom">
                    ...
                    <form name="form" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div id="div_dados" style="display:block;">
                            ...
                            <div class="form-group">
                                <input type="text" name="cnpj" id="cnpj" class="form-control" required="required" placeholder="CNPJ" autocomplete="off" maxlength="18" minlength="18"  onkeypress="validoff()" >
                                <span class="valid vcnpj">Campo obrigatório *</span>
                                <span class="valid vcnpj2">CNPJ inválido *</span>
                            </div>
                            <div class="form-group">
                                <input type="text" name="razaosocial" id="razaosocial" class="form-control" required="required" placeholder="Razão Social" autocomplete="off" onkeypress="validoff()">
                                <span class="valid vrazaosocial">Campo obrigatório *</span>
                            </div>
                            <div class="form-group">
                                <input type="text" name="nomefantasia" id="nomefantasia" class="form-control" required="required" placeholder="Nome Fantasia" autocomplete="off" onkeypress="validoff()">
                                <span class="valid vnomefantasia">Campo obrigatório *</span>
                            </div>
                            <div class="form-group">
                                <input type="text" name="responsavel" id="responsavel" class="form-control" required="required" placeholder="Nome do Responsavel" autocomplete="off" onkeypress="validoff()">
                            ...
                            <a href="#" id="dados-right" onclick="juridico_next(this)" class="right"><i class="fa fa-arrow-right fa-3x"></i></a>
                        </div>
                        ...
                        <div id="div_area" style="display:none;">
                            ...
                            <div id="setas" style="display: none;">
                                <a href="#" id="area-left" onclick="juridico_next(this)" class="left"><i class="fa fa-arrow-left fa-3x"></i></a>
                                <a href="#" id="area-right" onclick="juridico_next(this)" class="right"><i class="fa fa-arrow-right fa-3x"></i></a>
                            </div>
                        </div>
                        ...
                        <div id="div_endereco" style="display:none;">
                            ...
                            <div id="sub-end" style="display: none;">
                                ...
                                <a href="#" id="endereco-left" onclick="juridico_next(this)" class="left"><i class="fa fa-arrow-left fa-3x"></i></a>
                                <a href="#" id="endereco-right" onclick="juridico_next(this)" class="right"><i class="fa fa-arrow-right fa-3x"></i></a>
                            </div>
                        </div>
                        ...
                        <div id="div_pagina" style="display:none;">
                            ...
                            <a href="#" id="pagina-left" onclick="juridico_next(this)" class="left"><i class="fa fa-arrow-left fa-3x"></i></a>
                            <a href="#" id="pagina-right" onclick="juridico_next(this)" class="right"><i class="fa fa-arrow-right fa-3x"></i></a>
                        </div>
                        ...
                        <div id="div_acesso" style="display:none;">
                            ...
                            <a href="#" id="acesso-left" onclick="juridico_next(this)" class="left"><i class="fa fa-arrow-left fa-3x"></i></a>
                        </div>
                    </form>
                </div>
            </div>
